...
def rmTest():   
    RandMquotes = [
        'Your still learning English? It\'s the language you speak..\nHow dumb are you?',
        'Your still learning English? It\'s the language you speak..\nHow dumb are you?',
        'Your still learning English? It\'s the language you speak..\nHow dumb are you?',
        'Your still learning English? It\'s the language you speak..\nHow dumb are you?',
        'Wubba Lubba Dub-Dub',
        ...
        '''“To live is to risk it all;\notherwise you're just an inert chunk of randomly assembled molecules drifting wherever the universe blows you.” — Rick.''',
    ...
    return (random.choice(RandMquotes))
